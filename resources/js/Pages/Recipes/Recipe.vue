            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p class="pt-3 pb-5 font-extrabold text-sm text-center">
                            {{ formatTime($attrs.recipe.data.totalTime) }} |
                            SERVES {{ quantity }}
                        </p>
                            ...
                            <div id="tab-content" class="w-11/12">
                                <div class="md:flex">
                                    <div
                                        ref="tab-1"
                                        :class="{
                                            'mmd:hidden': activeTab !== 'tab-1',
                                        }"
                                        class="md:mr-2 p-6 border-solid border-2 border-neutral-200 rounded-xl md:w-1/2 lg:w-1/3"
                                    >
                                        <div
                                            v-for="(ingredient, index) in $attrs
                                    ...
                                    <div
                                        ref="tab-2"
                                        :class="{
                                            'mmd:hidden': activeTab !== 'tab-2',
                                        }"
                                        class="p-6 border-solid border-2 border-neutral-200 rounded-xl md:w-1/2 lg:w-2/3"
                                    >
                                        <div
                                            v-for="(step, index) in attrs.recipe
                                                .data.steps"
                                            v-bind:key="index"
                                            class="flex pt-2"
                                        >
                                ...
                                <div
                                    ref="tab-3"
                                    :class="{
                                        'mmd:hidden': activeTab !== 'tab-3',
                                    }"
                                    class="md:mt-2 p-6 border-solid border-2 border-neutral-200 rounded-xl"
                                >
                                    <div>More info</div>
                                </div>
                            </div>
